...
namespace CandyWorld.Data.Migrations
{
    ...
    [Migration("20200603192240_AddedValidationOrders")]
    partial class AddedValidationOrders
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CandyWorld.Models.Candy", b =>
                {
            ...
            modelBuilder.Entity("CandyWorld.Models.Category", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CandyWorld.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("CandyWorld.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("CandyWorld.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("CandyWorld.Models.Candy", b =>
                {
                    b.HasOne("CandyWorld.Models.Category", "Category")
                        .WithMany("Candies")
            ...
            modelBuilder.Entity("CandyWorld.Models.OrderDetail", b =>
                {
                    b.HasOne("CandyWorld.Models.Candy", "Candy")
                        .WithMany()
                        .HasForeignKey("CandyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CandyWorld.Models.Order", "Order")
